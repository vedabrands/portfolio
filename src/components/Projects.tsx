const projects = [
  {
    ...
    // [PLACEHOLDER] Back-face brief for AI Content Generator:
    brief:
  ...
  },
  {
    ...
    // [PLACEHOLDER] Back-face brief for E-Commerce Dashboard:
    brief:
  ...
  },
  {
    ...
    // [PLACEHOLDER] Back-face brief for Smart Home IoT:
    brief:
  ...
  },
  {
    ...
    // [PLACEHOLDER] Back-face brief for Portfolio CMS:
    brief:
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10 lg:gap-12">
          {projects.map((project, idx) => (
            ...
            >
              ...
              <div className={`card-floating-body preserve-3d w-full h-full ${project.floatClass}`}>
