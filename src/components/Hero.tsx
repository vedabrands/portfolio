      ...
      <div className="absolute inset-0 z-10 flex items-end pb-32 sm:pb-36 md:pb-40 pointer-events-none">
        <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-3 max-w-4xl">
            ...
            <div className="grid grid-cols-1 grid-rows-1 min-h-[160px] sm:min-h-[220px] md:min-h-[280px] lg:min-h-[340px]">
              {HEADLINES.map((hl, i) => (
                <h1
                  key={`headline-${i}`}
                  className={`col-start-1 row-start-1 font-display font-black text-7xl sm:text-8xl md:text-9xl lg:text-[10rem] xl:text-[11.5rem] text-foreground uppercase tracking-[-0.06em] leading-[0.78] transition-all ${
                    i === activeSector
